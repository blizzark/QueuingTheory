    ...
    public partial class MainForm : Form
    {
     ...
     (System.Globalization.CultureInfo)System.Threading.Thread.CurrentThread.CurrentCulture.Clone();
        ...
        private ParametersContainer ParseDiagramParameters()
        {
            ...
            double timeobrabotki = (double)numericUpDown1.Value;
            ...
            return new ParametersContainer(timeobrabotki, threadIntencity, queuePlaceCount, minRndValue, timeLimit, maxTime, clientsLimit, maxClients, preferFirstChannel, channels.ToArray());
        }
            ...
            try
            {
                using (OpenFileDialog dialog = new OpenFileDialog() { FileName = "config.xml" })
                {
                       ...
                       FileMode.Open, FileAccess.Read, FileShare.None))
                    {
                        ...
                        numericUpDown1.Value = (decimal)config.NumericUpDown1;
        ...
        private void button1_Click(object sender, EventArgs e) => controller.MakeDiagram() ;

        private void button2_Click(object sender, EventArgs e) => controller.MakeDiagramAnalyze();

        private void threadIntencity_Numeric_ValueChanged(object sender, EventArgs e)
        {
