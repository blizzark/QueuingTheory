...
namespace QTS.Core.Diagram
{
    ...
    public class ParametersContainer
    {
        ...
        public double NumericUpDown1 { get; set; }
        ...
        public ParametersContainer(double time, int threadIntencity, int queueCapacity,
        ...
        //    if (MinRandomValue != 0)
           ...
           //     text += $" Ограничение по времени: {TimeLimit} ч\r\n";
            ...
            if (HasClientLimit)
                text += $" Интенсивность потока:  {ClientLimit} шт/ч\r\n";
